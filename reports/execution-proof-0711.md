...
| sdk version resolved | `@hardkas/sdk@0.7.13-alpha` |
| cli version resolved | `@hardkas/cli@0.7.13-alpha` |
...
Install command: npm install @hardkas/sdk@0.7.13-alpha @hardkas/cli@0.7.13-alpha
...
**Zero new regressions introduced by 0.7.13-alpha.**
