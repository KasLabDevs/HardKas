...
| sdk version resolved | `@hardkas/sdk@0.8.2-alpha` |
| cli version resolved | `@hardkas/cli@0.8.2-alpha` |
...
Install command: npm install @hardkas/sdk@0.8.2-alpha @hardkas/cli@0.8.2-alpha
...
**Zero new regressions introduced by 0.8.2-alpha.**
