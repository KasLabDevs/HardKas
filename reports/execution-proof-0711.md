# HardKAS 0.7.12-alpha — Execution Proof
...
| sdk version resolved | `@hardkas/sdk@0.7.12-alpha` |
| cli version resolved | `@hardkas/cli@0.7.12-alpha` |
...
Install command: npm install @hardkas/sdk@0.7.12-alpha @hardkas/cli@0.7.12-alpha
...
**Zero new regressions introduced by 0.7.12-alpha.**
