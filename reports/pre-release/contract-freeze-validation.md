...
This report validates the freezing of the public local runtime contracts for HardKAS `0.7.7-alpha`. We ensured that new versions of outputs are securely versioned, while retaining full backwards compatibility with legacy artifacts.
