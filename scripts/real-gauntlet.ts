...
async function main() {
  ...
  const installCmd = "npm install @hardkas/sdk@0.7.8-alpha @hardkas/cli@0.7.8-alpha @hardkas/react@0.7.8-alpha @hardkas/query-store@0.7.8-alpha react react-dom vite express --no-audit --no-fund --legacy-peer-deps";
...
`;
  ...
  const productFitMd = `# SDK Product Fit Analysis — HardKAS 0.7.8-alpha
