...
for (const file of files) {
  ...
  if (content.includes('handleError(') && !content.includes('import { handleError }') && !content.includes('import { UI, handleError }') && !content.includes('import { handleError, UI }')) {
    // If it imports UI from "../ui.js", we can change it to import { UI, handleError }
    if (content.includes('import { UI } from "../ui.js";')) {
      content = content.replace('import { UI } from "../ui.js";', 'import { UI, handleError } from "../ui.js";');
  ...
  if (content.includes('handleLockError(') && !content.includes('handleLockError }')) {
    if (content.includes('import { UI, handleError } from "../ui.js";')) {
      content = content.replace('import { UI, handleError } from "../ui.js";', 'import { UI, handleError, handleLockError } from "../ui.js";');
    } else if (content.includes('import { handleError } from "../ui.js";')) {
      content = content.replace('import { handleError } from "../ui.js";', 'import { handleError, handleLockError } from "../ui.js";');
    } else {
