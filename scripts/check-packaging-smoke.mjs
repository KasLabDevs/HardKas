...
try {
  ...
  if (!versionOut.includes("0.12.0-alpha")) {
    throw new Error(`CLI version mismatch. Expected 0.12.0-alpha, got ${versionOut}`);
  }
...
if (HARDKAS_VERSION !== "0.12.0-alpha") throw new Error("SDK version mismatch");
