...
try {
  ...
  if (!versionOut.includes("0.9.4-alpha")) {
    throw new Error(`CLI version mismatch. Expected 0.9.4-alpha, got ${versionOut}`);
  }
...
if (HARDKAS_VERSION !== "0.9.4-alpha") throw new Error("SDK version mismatch");
