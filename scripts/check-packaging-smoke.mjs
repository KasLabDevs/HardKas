...
try {
  ...
  if (!versionOut.includes("0.11.6-alpha")) {
    throw new Error(`CLI version mismatch. Expected 0.11.6-alpha, got ${versionOut}`);
  }
...
if (HARDKAS_VERSION !== "0.11.6-alpha") throw new Error("SDK version mismatch");
