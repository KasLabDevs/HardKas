...
try {
  ...
  if (!versionOut.includes("0.12.0-rc.18")) {
    throw new Error(`CLI version mismatch. Expected 0.12.0-rc.18, got ${versionOut}`);
  }
...
if (HARDKAS_VERSION !== "0.12.0-rc.18") throw new Error("SDK version mismatch");
