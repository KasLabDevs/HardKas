...
export interface GauntletEvidence {
    app: string;
    actors: number;
    operations: number;
    visualScenario: boolean;
    realRpcTouched: boolean;
    realBroadcast: boolean;
    domainOperationReal: boolean;
    networkSettlementReal: boolean;
    fallbackUsed: boolean;
    packagesExercised: string[];
    publicApisExercised: string[];
    errors: string[];
    expectedGuards: string[];
    unsupportedCapabilities: string[];
}

export function writeEvidence(app: string, evidence: GauntletEvidence) {
