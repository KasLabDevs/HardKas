...
This document captures the frictions encountered when attempting to build a Wallet Optimizer application using only the existing `WalletToolkit` (v0.11.1-alpha).
