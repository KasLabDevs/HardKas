...
2. `pnpm pack` en `packages/sdk`, generando `hardkas-sdk-0.12.0-rc.18.tgz`.
3. Creación de entorno con `npm init -y`.
4. Instalación del tarball: `npm install C:\...\hardkas-sdk-0.12.0-rc.18.tgz`.

### Resultado y Taxonomía de Bloqueo
- **Estado:** ❌ FALLO (Bloqueante)
- **Error:** `npm error notarget No matching version found for @hardkas/accounts@0.12.0-rc.18.`
...
- En el monorepo: artefactos de build y `hardkas-sdk-0.12.0-rc.18.tgz`
