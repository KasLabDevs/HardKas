...
**Date:** 2026-05-28
**Sprint Goal:** Fix the two release blockers found by the Nightmare Suite before tagging `0.8.0-alpha`.
...
**Status:** ALL BLOCKERS RESOLVED. Ready for `0.8.0-alpha` release.
