# Execution Proof 0.7.13-alpha

This document serves as proof of the Phase 7-C Gauntlet run executed against the real NPM registry.

## Run Parameters
- **Target**: `@hardkas/sdk@0.7.13-alpha`
- **Installation Method**: `npm install @hardkas/sdk@0.7.13-alpha`
...
Installing @hardkas/sdk@0.7.13-alpha...
