# Fix Report — HardKAS 0.9.2-alpha Audit Findings
...
**Change:** `"version": "0.9.0-alpha"` → `"version": "0.9.2-alpha"`  
**Verification:** `pnpm version:check` now reports "All workspace packages match version 0.9.2-alpha!"
...
- Heading line 5: `## 0.9.2-alpha - SDK Parity / Developer Experience - Draft` → `## 0.9.2-alpha - SDK Parity + Programmability Builder Surface - 2026-06-10`
- Description line 10: "patch for the `0.9.2-alpha` Toccata local-first baseline" → "patch for the `0.9.0-alpha` Toccata local-first baseline" (erroneous self-reference fixed)
...
**Status:** Already updated to `0.9.2-alpha` by developer before audit fix phase. Confirmed current content: "HardKAS is currently **0.9.2-alpha**."
...
| Gate                             | Status   | Notes                                                                                                                                                                                                                                                                                                      |
| -------------------------------- | -------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `pnpm version:check`             | **PASS** | All 47 packages at 0.9.2-alpha                                                                                                                                                                                                                                                                             |
...
| `pnpm test`                      | **PASS** | 164 tests, 48 test files; `hardkasVersion: "0.9.2-alpha"` visible in output                                                                                                                                                                                                                                |
