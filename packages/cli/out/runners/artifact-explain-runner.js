...
export async function runArtifactExplain(options) {
    ...
    // 1. Summary Section
    console.log("â”Œâ”€â”€ SUMMARY â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€");
    ...
    console.log(`â”‚ STATUS:    ${explanation.summary.status.toUpperCase().padEnd(48)} â”‚`);
    ...
    if (explanation.economics) {
        ...
        console.log(`\n  Fees:`);
        console.log(`    Reported:   ${formatSompiToKas(explanation.economics.fee.reported)}`);
        console.log(`    Recomputed: ${formatSompiToKas(explanation.economics.fee.recomputed)}`);
        ...
        console.log(`\n  Balance Sheet:`);
        console.log(`    Total Inputs:  ${formatSignedSompiToKas(explanation.economics.balance.inputs)}`);
        console.log(`    Total Outputs: ${formatSignedSompiToKas(explanation.economics.balance.outputs)}`);
        if (explanation.economics.balance.change > 0n) {
            console.log(`    Change:        ${formatSignedSompiToKas(explanation.economics.balance.change)}`);
        }
        console.log(`    Implied Fee:   ${formatSignedSompiToKas(explanation.economics.balance.impliedFee)}`);
    }
    // 4. Security Section
    console.log("\n[ SECURITY & INTEGRITY ]");
    if (explanation.security.strictOk) {
        ...
        const hasErrors = explanation.security.issues.some((i) => i.severity === "critical" || i.severity === "error");
        if (hasErrors) {
...
//# sourceMappingURL=artifact-explain-runner.js.map