...
export async function runArtifactLineage(options) {
    ...
    if (failed) {
        const { HardkasCliError } = await import("../cli-errors.js");
        throw new HardkasCliError("LINEAGE_VIOLATIONS", "Lineage structure is inconsistent.", { exitCode: 1 });
    }
}
//# sourceMappingURL=artifact-lineage-runner.js.map