...
export async function runDoctorSigner(options = {}) {
    ...
    if (status.available) {
        ...
        try {
            ...
            UI.logHuman(`Failed to inspect exports: ${e instanceof Error ? ((e instanceof Error) ? ((e instanceof Error) ? e.message : String(e)) : String(e)) : String(e)}`);
        }
    }
    else {
...
//# sourceMappingURL=doctor-signer-runner.js.map