...
export async function runL2RpcHealth(options) {
    ...
    if (!health.ready || chainIdMismatch) {
        ...
        throw new HardkasCliError("RPC_UNHEALTHY", "RPC endpoint is not healthy or chain ID mismatches.", { exitCode: 1 });
    }
}
//# sourceMappingURL=l2-rpc-health-runner.js.map