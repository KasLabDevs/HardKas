...
export async function runDevEnv(options) {
    ...
    try {
        ...
        throw new HardkasCliError("WORKSPACE_NOT_FOUND", `Config load failed: Not a valid HardKAS workspace. (${((e instanceof Error) ? ((e instanceof Error) ? e.message : String(e)) : String(e))})`, {
            exitCode: 1,
...
//# sourceMappingURL=dev-env-runner.js.map