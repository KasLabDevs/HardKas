...
export async function runSandbox(options) {
    try {
        ...
        const devCtx = await runDevServer({
            port,
            host,
        ...
        throw new HardkasCliError("SANDBOX_FAILED", `Sandbox initialization failed: ${((e instanceof Error) ? ((e instanceof Error) ? e.message : String(e)) : String(e))}`, { exitCode: 1, cause: e });
    }
}
