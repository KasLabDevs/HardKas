...
export async function runL2ProfileValidate(options) {
    ...
    if (finalOk) {
        ...
        throw new HardkasCliError("INVALID_PROFILE", `L2 profile '${profile.name}' is INVALID`, { exitCode: 1 });
    }
}
//# sourceMappingURL=l2-profile-validate-runner.js.map