...
`;
    ...
    if (failedRuns > 0) {
        ...
        throw new HardkasCliError("CHAOS_CAMPAIGN_FAILED", `Chaos campaign completed with ${failedRuns} failures. See ${reportsDir} for details.`, { exitCode: ChaosExitCodes.INVARIANT_VIOLATION });
    }
    else {
