...
export async function runUp() {
    ...
    try {
        ...
        try {
            ...
            console.log(`  \x1b[33m⚠\x1b[0m RPC check failed: ${e instanceof Error ? ((e instanceof Error) ? ((e instanceof Error) ? e.message : String(e)) : String(e)) : String(e)}`);
        }
        finally {
            await client.close();
        }
...
//# sourceMappingURL=up-runner.js.map