...
import { runLocalnetFork, runLocalnetFund, runLocalnetStart, runLocalnetStatus, runLocalnetStop } from "../runners/localnet-runners.js";
import { parseKasToSompi } from "@hardkas/core";
export function registerLocalnetCommands(program) {
