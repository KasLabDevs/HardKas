    ...
    ciCmd
        ...
        try {
            ...
            if (hasErrors) {
                ...
                throw new HardkasCliError("CI_VERIFY_FAILED", "CI Verification Failed. Workspace is corrupted or incorrectly configured.", { exitCode: HardkasExitCode.RUNTIME_FAILURE });
            }
            else {
