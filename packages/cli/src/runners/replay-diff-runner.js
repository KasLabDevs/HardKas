...
import { diffReplays } from "@hardkas/core";
import { UI } from "../ui.js";
export async function runReplayDiff(options) {
    ...
    if (diffResult.structural.missingArtifacts.length === 0 &&
    ...
    if (diffResult.observational.timestampShifts.length === 0 &&
...
//# sourceMappingURL=replay-diff-runner.js.map