import { resolveL2Profile, EvmJsonRpcClient, formatWeiAsEtherLike } from "@hardkas/l2";
...
export async function runL2Balance(address, options) {
...
export async function runL2Nonce(address, options) {
    const { client, profile } = await getClient(options);
    const blockTag = options.block ?? "latest";
...
//# sourceMappingURL=l2-account-runners.js.map