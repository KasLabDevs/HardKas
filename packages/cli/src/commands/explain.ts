    ...
    .action(async (id: string) => {
      try {
        ...
        UI.causality("Execution Trace", {
          ...
          "Replay Result": isSimulated ? "deterministic reproduction successful" : "network state dependent",
          "Consensus Validation": isSimulated ? "NOT performed" : "performed by remote node",
          "Reason": isSimulated ? "simulated execution mode does not validate against Kaspa consensus" : "network interaction implies Kaspa consensus"
        });
