...
export function printArtifactList(result) {
...
export function printInspectResult(result) {
...
export function printDiffResult(result) {
...
export function printLineageChain(result) {
...
export function printTransitions(result) {
...
export function printOrphans(result) {
    if (result.total === 0) {
...
export function printReplayList(result) {
...
export function printReplaySummary(result) {
    ...
    if (s.preStateHash)
        console.log(`  ${pc.dim("Pre-state:")}  ${pc.dim(s.preStateHash.slice(0, 16) + "...")}`);
    if (s.postStateHash)
        console.log(`  ${pc.dim("Post-state:")} ${pc.dim(s.postStateHash.slice(0, 16) + "...")}`);
    console.log("");
}
export function printDivergences(result) {
    if (result.total === 0) {
...
export function printDagConflicts(result) {
...
export function printDagDisplaced(result) {
    console.log(pc.dim("\n  ⚠ DAG model: deterministic-light-model (NOT GHOSTDAG)\n"));
    if (result.total === 0) {
...
export function printDagHistory(result) {
    console.log(pc.dim("\n  ⚠ DAG model: deterministic-light-model (NOT GHOSTDAG)\n"));
    if (result.total === 0) {
...
export function printSinkPath(result) {
    console.log(pc.dim("\n  ⚠ DAG model: deterministic-light-model (NOT GHOSTDAG)\n"));
...
export function printDagAnomalies(result) {
    console.log(pc.dim("\n  ⚠ DAG model: deterministic-light-model (NOT GHOSTDAG)\n"));
    if (result.total === 0) {
...
export function printRpcHealthTimeline(result) {
...
export function printRpcDegradations(result) {
    if (result.total === 0) {
...
export function printRpcCorrelation(result) {
    ...
    const assessColor = c.assessment === "optimal"
        ? pc.green
...
export function printCorrelationBundle(result) {
    ...
    if (b.rpc) {
        const status = b.rpc.assessment === "optimal"
...
export function printExplainChains(chains) {
