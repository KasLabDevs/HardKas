...
export type SubscriptionRequest<T extends EventType> = T extends "blockAdded" ? {
    type: T;
} : T extends "utxosChanged" ? {
    type: T;
    addresses: readonly string[];
} : T extends "transactionObserved" ? {
    type: T;
    txIds: readonly string[];
} : T extends "transactionAcceptanceChanged" ? {
    type: T;
    txIds: readonly string[];
