...
// silverc level (AUD-41): the drafts below are built from a contract compiled with the
// pinned silverc in HARDKAS_HOME. buildScriptFunding cases moved to silver-funding.test.ts.
