...
export function createEmptyRealAccountStore(): RealAccountStore {
  return {
    ...
    connectionMode: "node",
    warning:
      "HardKAS: Development account store. Encrypted storage is default. Unsafe plaintext storage is legacy.",
    accounts: []
  };
}
...
export function listRealDevAccounts(store: RealAccountStore): readonly RealDevAccount[] {
