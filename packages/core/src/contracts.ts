...
export const SystemContracts = {
  ...
  Artifact: (name: string, schema: z.ZodSchema<any>) =>
    createContract(`Artifact:${name}`, schema),

  // RPC Responses
  RpcResponse: (method: string, schema: z.ZodSchema<any>) =>
    createContract(`RPC:${method}`, schema)
};
