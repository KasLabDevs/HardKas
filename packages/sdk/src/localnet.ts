...
export class HardkasLocalnet {
  ...
  async start(options: LocalnetProfileOptions = {}): Promise<LocalnetControlResult> {
    ...
    return {
      ...
      message:
        "SDK Docker localnet start is not supported in 0.9.3-alpha. Use `hardkas localnet start --profile toccata-v2`."
    };
  }
  ...
  async fund(
    ...
    return {
      ...
      message:
        "SDK Toccata funding is not supported in 0.9.3-alpha. Use `hardkas localnet fund <account> --profile toccata-v2`."
    };
  }
