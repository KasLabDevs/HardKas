...
export const RUSTY_KASPA_V2_SNAPSHOT: SnapshotOperation[] = [
  ...
  { operation: "getVirtualChainFromBlockV2", requestType: "GetVirtualChainFromBlockV2RequestMessage", responseType: "GetVirtualChainFromBlockV2ResponseMessage", category: "read", securityProfile: "public", requiredNodeFeatures: [] },
