...
HardKAS `0.10.0-alpha` is local-first deterministic transaction infrastructure
...
The `0.10.0-alpha` release line includes a normalized Toccata v2 localnet flow:
...
### 0.10.0-alpha SDK Parity

`0.10.0-alpha` is a SDK parity / developer experience patch. It adds high-level
...
### 0.10.0-alpha Programmability Builder Surface

`0.10.0-alpha` also includes a local-only builder surface for SilverScript,
