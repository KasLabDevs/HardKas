# HardKAS 0.12.0-rc.17 Programmability Builder Surface

HardKAS 0.12.0-rc.17 exposes a local-first programmability surface for app builders:
...
HardKAS 0.12.0-rc.17 does not claim on-chain ZK verification, full vProgs runtime, bridge behavior, trustless exits, testnet readiness, mainnet readiness, or Kaspa VM/consensus equivalence.
