# HardKAS 0.11.6-alpha Programmability Builder Surface

HardKAS 0.11.6-alpha exposes a local-first programmability surface for app builders:
...
HardKAS 0.11.6-alpha does not claim on-chain ZK verification, full vProgs runtime, bridge behavior, trustless exits, testnet readiness, mainnet readiness, or Kaspa VM/consensus equivalence.
