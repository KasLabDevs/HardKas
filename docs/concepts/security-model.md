...
> [!IMPORTANT]
> HardKAS does not replace Kaspa consensus. HardKAS protects the _client execution environment_. A perfectly signed HardKAS transaction can still be rejected by a Kaspa node if the inputs were already spent.
