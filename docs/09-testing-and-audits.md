...
HardKas makes local-first reliability and safety claims. The 0.9.3-alpha line should be judged by whether a developer can initialize a workspace, create local artifacts, replay them, query them, and detect obvious corruption without touching mainnet.
