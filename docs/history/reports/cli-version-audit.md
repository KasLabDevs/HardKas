...
| :--- | :--- | :--- | :--- |
| **CLI Manifest** | `0.6.0-alpha` | `packages/cli/package.json` | `MATCH` |
| **CLI Runtime** | `0.6.0-alpha` | `packages/cli/src/index.ts` | `MATCH` |
| **Artifact Metadata**| `0.6.0-alpha` | `packages/artifacts/src/constants.ts` | `MATCH` |
| **CLI Output** | `0.6.0-alpha` | `hardkas --version` | `MATCH` |
...
| `packages/artifacts/src/constants.ts` | `export const HARDKAS_VERSION = "0.6.0-alpha";` | package hardcode | Validated by sync script |
| `packages/cli/package.json` | `"version": "0.6.0-alpha"` | manifest | **Source of Truth** |
| `packages/artifacts/package.json` | `"version": "0.6.0-alpha"` | manifest | Validated by sync script |
