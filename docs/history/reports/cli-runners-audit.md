...
| `dag-runners.ts`   | `"Minimal 0.7.5-alpha implementation"` | `PARTIAL`                   | Expand simulated GHOSTDAG logic.                            |
...
export async function runTxPlan(
  ctx: RunnerContext,
  input: TxPlanInput
): Promise<RunnerResult<TxPlanArtifact>> {
