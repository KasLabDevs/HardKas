...
_Recommended mitigation for Artifact Bloat_: Introduce an automated storage compaction workflow (`hardkas workflow compact`) to archive old verified execution lineages into unified zip indexes.
