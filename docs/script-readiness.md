...
They denote the *intent* of a transaction (e.g., this payload complies with Tockata standards). However, HardKAS **does not** execute SilverScript or Tockata contracts on-chain. There is no active covenant runtime.
