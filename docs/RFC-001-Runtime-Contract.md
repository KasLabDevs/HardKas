...
- **Projection Lag:** Projection lag must _never_ corrupt authority. A stale projection must fail gracefully or trigger a rebuild.
...
The question _"When does something exist?"_ is the core of the runtime. Artifacts transition through strict visibility states:
...
_Rationale:_ Policy context, runtime version, and schema version inherently alter execution semantics and must be part of the execution identity.
