...
| :--- | :--- | :--- | :--- |
| **CLI Package Version** | `0.5.3-alpha` | `package.json` | Version declared in the CLI package manifest |
| **CLI Runtime Version** | `0.5.3-alpha` | `index.ts` | `HARDKAS_VERSION` constant in source code |
