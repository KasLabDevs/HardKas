...
HardKAS is event-sourced. The system is designed to explain _why_ it failed and offer precise, surgical recovery commands.
...
_Tip: Add `--strict` in your CI pipelines to fail the build if any anomaly is detected._
...
The repair wizard will identify the exact line, explain the context, and ask for permission to truncate the garbage bytes. It will _never_ delete the file.
