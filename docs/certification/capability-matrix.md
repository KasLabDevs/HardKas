...
This matrix describes the capabilities HardKas should prove before a release is treated as stable. For 0.11.0-alpha, the priority is the local-first development loop.
...
Status: out of scope for the 0.11.0-alpha happy path
