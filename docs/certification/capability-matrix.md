...
This matrix describes the capabilities HardKas should prove before a release is treated as stable. For 0.12.0-rc.19, the priority is the local-first development loop.
...
Status: out of scope for the 0.12.0-rc.19 happy path
