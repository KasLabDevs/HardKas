...
The Operational Query Layer is the backbone of HardKAS's observability and introspection system. It allows developers to understand _exactly_ what happened during a transaction lifecycle, a localnet session, or a replay execution.
...
- **Explain Chains**: Rule-based reasoning that explains _why_ a certain result was returned (e.g., why a transaction is considered "orphaned").
