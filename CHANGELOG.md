...
## [0.11.1-alpha] - 2026-06-27 — Toolkit Baseline
### Added
...
- **P7: Version Boundary Alignment**
  A synchronized `0.11.1-alpha` version line across all packages, generated capabilities schemas, CLI help menus, and documentation.
...
## 0.11.1-alpha - Deployed & Builder-Ready - 2026-06-11

HardKAS `0.11.1-alpha` has successfully passed the Extreme Builder Gauntlet. This release marks our transition from raw engineering pipelines into a fully usable **Builder Layer** experience for Kaspa.
...
## 0.11.1-alpha - CI Fixes + Query-Store SQL Repair - 2026-06-11
