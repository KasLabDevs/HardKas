...
export const ProvenancePanel: React.FC<ProvenanceProps> = ({
  ...
  const getIntegrityIcon = () => {
    switch (integrity) {
      ...
      default:
        return <AlertTriangle size={14} className="text-zinc-400" />;
    }
  };
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-1">
            ...
            <div className="flex items-center gap-1.5 text-xs font-bold uppercase tracking-wider">
              {getIntegrityIcon()}
              <span className={getIntegrityColor()}>{integrity}</span>
            </div>
          </div>
          ...
          <div className="space-y-1">
            ...
            <div className="text-xs font-bold text-zinc-300">{replayScope}</div>
          </div>
          ...
          <div className="space-y-1">
            ...
            <div
              className={`text-xs font-bold ${consensusValidated ? "text-emerald-400" : "text-zinc-500"}`}
            >
