...
## HardKAS 0.11.1-alpha Security Posture

HardKAS 0.11.1-alpha is local-first tooling for the Kaspa/Toccata development
...
Mainnet signing and broadcasting are outside the 0.11.1-alpha release claim.
