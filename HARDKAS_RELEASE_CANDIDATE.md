# HardKAS 0.11.0-alpha: Release Candidate Manifest
...
HardKAS `0.11.0-alpha` is strictly bounded as a robust, reproducible, local-first runtime. No false claims are made regarding network functionality.
